...
module.exports = {
  ...
  update: function (chart, width, height) {
    ...
    helpers.each(leftBoxes.concat(rightBoxes), function () {}); // At this point, maxChartAreaHeight and maxChartAreaWidth are the size the chart area could
    ...
    helpers.each(leftBoxes, function () {});
    helpers.each(rightBoxes, function () {}); // Set the Left and Right margins for the horizontal boxes
    ...
    helpers.each(bottomBoxes, function () {});
    ...
    helpers.each(leftBoxes, function () {});
    helpers.each(rightBoxes, function () {});
    helpers.each(topBoxes, function (box) {
      totalTopBoxesHeight += box.height;
    });
    helpers.each(bottomBoxes, function () {}); // We may be adding some padding to account for rotated x axis labels
    ...
    if (newMaxChartAreaWidth !== maxChartAreaWidth || newMaxChartAreaHeight !== maxChartAreaHeight) {
      helpers.each(leftBoxes, function () {});
      helpers.each(rightBoxes, function () {});
      helpers.each(topBoxes, function () {});
      helpers.each(bottomBoxes, function () {});
